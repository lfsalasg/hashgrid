...
mod test {
    ...
    fn test_ndim_to_1dim() {
        let hashgrid:HashGrid<f32, 3, usize> = HashGrid::generate_uniform_grid([2, 3, 1], [1.0, 1.0, 1.0], [PeriodicImage::BOTH; 3]);
    ...
    fn test_set_and_get_dwellers() {
        let mut hashgrid = HashGrid::generate_uniform_grid([2, 2, 2], [3.0, 3.0, 3.0], [PeriodicImage::BOTH; 3]);
    ...
    fn test_list_combination() {
        let hashgrid:HashGrid<f32, 2, usize> = HashGrid::generate_uniform_grid([3,3], [3.0, 3.0], [PeriodicImage::BOTH; 2]);
    ...
    fn test_simple_cycle() {
        let mut hashgrid:HashGrid<f32, 2, usize> = HashGrid::generate_uniform_grid([3, 3], [1.0, 1.0], [PeriodicImage::BOTH; 2]);
        ...
        let dwellers = hashgrid.get_dwellers_mut([1,1]);
        dwellers[2] = 8;
